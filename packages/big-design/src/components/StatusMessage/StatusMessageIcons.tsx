...
import { StyledStatusMessageIcons } from './styled';

export interface StatusMessageIconProps {
  variant?:
    | '404'
    | 'error'
    | 'info'
...
export const StatusMessageIcons: React.FC<StatusMessageIconProps> = ({ variant = 'info' }) => {
  return (
    <StyledStatusMessageIcons>
      {variant === '404' && (
