  ...
  return (
    <>
      ...
      <Panel header="Overview" headerId="overview">
        ...
        <List>
          <List.Item>
            Use when there is indeterminant progress, where there is an unknown amount of time for a
            task to complete.
          </List.Item>
        </List>
        ...
        <List>
          <List.Item>
            Use when there is determinant progress, where there is a known amount of time for a task
            to complete.
          </List.Item>
        </List>
      </Panel>
      ...
      <Panel header="Do's and Don'ts" headerId="guidelines">
        <GuidelinesTable
          ...
          recommended={[
            ...
            <>
              If progress is determinate, use a percentage to reflect the completeness of the
              action.
            </>,
          ]}
        />
