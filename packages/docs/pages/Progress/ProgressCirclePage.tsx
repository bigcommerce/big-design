import { H1, Panel, ProgressCircle, Tabs, Text } from '@bigcommerce/big-design';
...
const ProgressCirclePage = () => {
  ...
  const renderTabs = () => {
    switch (activeTab) {
      case 'code':
        return <ProgressCirclePropTable />;
      case 'examples':
      default:
        return (
          <>
  ...
  return (
    <>
      ...
      <Text>Use a Progress circle to indicate progress in a process that's happening behind the scenes.</Text>
