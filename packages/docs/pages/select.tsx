    ...
    <>
              ...
              render: () => (
                <Fragment key="position">
                  <Text>
                    ...
                    <Code primary>position</Code> property. It will automatically find a position if there's not enough
            ...
            },
            {
              ...
              render: () => (
                <Fragment key="disabled">
                  <Text>
                    It is possible to disable the entire <Code primary>Select</Code> component, similar to how you would
                    disable a native HTML select element, by using the <Code primary>disabled</Code> property.
                  </Text>
      ...
      <Panel header="Do's and Don'ts" headerId="guidelines">
        <GuidelinesTable
          ...
          discouraged={[
            <>
              Don’t use <Code primary>Select </Code>component when user needs to make more than one selection (see{' '}
              <NextLink href="/multi-select">MultiSelect</NextLink>).
            </>,
            <>
              In most cases avoid using long <Code primary>labels</Code> (ideally less than three words).
            </>,
          ]}
        />
      </Panel>
