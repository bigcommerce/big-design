import { H0, H1, H2, StatefulTree, Worksheet } from '@bigcommerce/big-design';
    ...
    <>
      ...
      <CodePreview scope={{ CATEGORIES, CategoryTree, nodes }}>
        ...
        {function Example() {
          ...
          return <Worksheet columns={columns} items={items} onChange={(items) => items} onErrors={(items) => items} />;
        }}
        {/* jsx-to-string:end */}
      </CodePreview>
      ...
      <H2>Usage with number columns</H2>
      <CodePreview>
        {/* jsx-to-string:start */}
        {function Example() {
      ...
      <H2>Usage with checkbox columns</H2>
      <CodePreview>
        {/* jsx-to-string:start */}
        {function Example() {
          const columns: WorksheetColumn<Partial<Product>>[] = [
      ...
      <H2>Usage with selectable columns</H2>
      <CodePreview>
        {/* jsx-to-string:start */}
        {function Example() {
          const columns: WorksheetColumn<Partial<Product>>[] = [
      ...
      <H2>Usage with modal columns</H2>
      <CodePreview scope={{ CATEGORIES, CategoryTree, nodes }}>
        {/* jsx-to-string:start */}
        {function Example() {
          const columns: WorksheetColumn<Partial<Product>>[] = [
