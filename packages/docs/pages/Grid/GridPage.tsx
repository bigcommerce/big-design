import { Box, Grid, GridItem, H1, Panel, Tabs, Text } from '@bigcommerce/big-design';
            ...
            <Panel header="Column layout">
              ...
              <CodePreview scope={{ ExampleBox }}>
                ...
                <Grid gridColumns="repeat(3, 1fr)">
                  ...
                  <GridItem>
                    <ExampleBox>
                      In sit dolore culpa reprehenderit tempor laborum. Sit anim voluptate pariatur irure amet mollit.
                      Est mollit ad pariatur esse eu reprehenderit ut veniam. Aliquip anim mollit aliquip quis officia
                      minim esse laboris proident fugiat cillum. Eiusmod culpa eu ea eiusmod nostrud.
                    </ExampleBox>
                  </GridItem>
