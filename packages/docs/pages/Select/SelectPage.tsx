  ...
  const items = [
    {
      ...
      render: () => (
        <>
          <Panel>
            <Text>Select are typeable inputs with selectable dropdown items.</Text>
            <CodePreview>
              {/* jsx-to-string:start */}
              {function Example() {
          ...
          <Panel header="Max height">
            <Text>
              Once the content is longer than the max-height, the Dropdown will be scrollable. It is possible to modify
              the dimension by passing a <Code primary>maxHeight</Code> property.
            </Text>
