...
<Dos hideHeader={true}>A stock keeping unit (SKU) is a unique code that helps you keep track of an item or service in your inventory.</Dos>

There’s no need to spell out commonly understood abbreviations and acronyms.

<Dos hideHeader={true}>Enter your PIN.</Dos>
...
<Dos hideHeader={true}>I had to return my new shoes because they were too small.</Dos>
...
<Dos hideHeader={true}>$100 (USD)</Dos>
