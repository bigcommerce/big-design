...
At BigCommerce, we use American English as the default language for UX writing. That doesn’t mean, however, we should run roughshod over the design without considering our global audience.

Regardless of the user, the country, or the region, we should take care to avoid words and phrases that may cause confusion or break the UI during localization.
...
<div>
For more stories, visit the [BigCommerce Blog](https://www.bigcommerce.com/blog/ "https://www.bigcommerce.com/blog/").
</div>
</Dos>
