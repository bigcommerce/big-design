...
Control panel is not a proper noun. No need to capitalize. Of course, always capitalize the first letter of the first word if it appears at the start of a sentence.
