...
- 2840841: build(deps): upgrade `next` 15.5.21 → 16.3.1 (docs site)
...
- 9c479e5: build(deps): upgrade `prettier` 2.8.8 → 3.9.6 (docs site)
...
- Updated dependencies [856d6a7]
  ...
  - @bigcommerce/big-design-patterns@7.0.0
...
- 9f6154c: Upgrade Next.js to 15.5.21+ to patch the July 2026 security release (CVE-2026-64641, CVE-2026-64642, CVE-2026-64643, CVE-2026-64644, CVE-2026-64645, CVE-2026-64646, CVE-2026-64647, CVE-2026-64648, CVE-2026-64649).
...
- fc0f96f: Fix PillTabs group separator padding and add `maxWidth` support to Dropdown.
...
- Updated dependencies [fc0f96f]
- Updated dependencies [1a80ed7]
  - @bigcommerce/big-design@2.5.0
