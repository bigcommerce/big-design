...
const counterProps: Prop[] = [
  {
    ...
    description: (
      <>
        Label element for counters. Component with auto generate <Code>id</Code>'s for the accessibility API.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        The amount beetween one <Code>value</Code> and the next when incrementing or decrementing the{' '}
        <Code>Counter</Code>.
      </>
    ),
  },
  {
    ...
    description: 'Function to be called that changes counter value. Receives the new count from the component.',
    required: true,
  },
];
