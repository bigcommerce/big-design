    ...
    <svg aria-hidden={ariaHidden} aria-labelledby={titleId} ref={svgRef} viewBox="0 0 640 480" {...props}>
      ...
      <defs>
        <clipPath id="NUFlagIcon__a">
          <path d="M0 0h496v372H0z" fillOpacity={0.7} />
        </clipPath>
      </defs>
      <g clipPath="url(#NUFlagIcon__a)" transform="scale(1.2902)">
        ...
        <path d="M51 0l144.6 75.5V0H51z" fill="#006" />
        <path d="M214.9 0v96.4H0v55h215v96.4h66v-96.4h215v-55H281V0h-66z" fill="#c00" />
        <path d="M300.2 0v71.1L441.6.6 300.2 0z" fill="#006" />
        <path d="M304.7 78.9l39.8-.3L498.9.6l-41 .6L304.8 79z" fill="#c00" />
        ...
        <g fillRule="evenodd">
          <path d="M290.9 125.3a42.8 42.8 0 11-85.5 0 42.8 42.8 0 0185.5 0z" fill="#000067" />
          <path
