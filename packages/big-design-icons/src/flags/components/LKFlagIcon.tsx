...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({ svgRef, title = 'LK flag', theme, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <use width="100%" height="100%" transform="matrix(-1 0 0 1 845.3 0)" xlinkHref="#LKFlagIcon__a" />
      <use width="100%" height="100%" transform="matrix(1 0 0 -1 0 480)" xlinkHref="#LKFlagIcon__a" />
      <use width="100%" height="100%" transform="rotate(180 422.7 240)" xlinkHref="#LKFlagIcon__a" />
      <g transform="translate(0 -76)">
        <use width="100%" height="100%" stroke="#000" strokeWidth={5.6} xlinkHref="#LKFlagIcon__b" />
        <g id="LKFlagIcon__b" fill="#ffb700">
