    ...
    <svg viewBox="0 0 640 480" aria-hidden={ariaHidden} ref={svgRef} aria-labelledby={titleId} {...props}>
      ...
      <g strokeMiterlimit={4.8}>
        ...
        <g fill="#00a651" stroke="#000" strokeWidth={0.8}>
          <path strokeWidth={0.5} d="M461.7 270.4s5.2 4.9 3.9 9.2c0 0 3.3-7.3-.3-9.5-3.6-2-3.7-.5-3.6.3z" />
          <path
            fill="#964b36"
            strokeWidth={0.5}
          ...
          />
          <path strokeWidth={0.5} d="M451.7 270.1s5.9 5.7 6.2 7.6c.4 1.8 1.8-5.7-1-7.8s-5.7-2.5-5.7-2.5l.5 2.8z" />
          <path
            fill="#964b36"
            strokeWidth={0.5}
          ...
          />
          <path strokeWidth={0.5} d="M443.7 282s-7.7-2.8-12 1.2c0 0 6.6 1 7.4 2.3.8 1.3 4.9-2.2 4.6-3.5z" />
          <path
            strokeWidth={0.5}
          ...
          />
          <path strokeWidth={0.5} d="M438.4 272s-.3-5.7 3.5-7.9c0 0 .7.2 1.1-1 0 0-3 7.3-2.1 11l-.1.4" />
          <path strokeWidth={0.5} d="M439.1 265s6.8-14 15-9.1c0 0-8.6 1.7-11.7 7.9l-3.1 4.6-.2-3.4z" />
          <path
            strokeWidth={0.5}
        ...
        <g fill="#964b36" stroke="#000" strokeWidth={0.5}>
          ...
          <path strokeWidth={0.3} d="M527.3 372.4s-3 .7-3.6 4.9c-.6 4.2-4.7 6.3-5 6.5m49.4-51.6s-4.4 1.6-3.7 4.7" />
        </g>
        <path
          fill="#fff200"
          stroke="#000"
