...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <path d="M0 0h640v480H0z" fill="#003da5" />
      <use
        height={700}
      ...
      />
      <path
        d="M472.9 262.8l-8.4 1.5-1.1 8.5-4.1-7.5-8.4 1.6 5.8-6.2-4-7.5 7.7 3.6 5.8-6.2-1 8.5z"
        fill="#fff"
        fillOpacity={1}
        fillRule="nonzero"
        id="PCFlagIcon__a"
      ...
      <use
        ...
        xlinkHref="#PCFlagIcon__a"
      />
      <path d="M444.9 313A151 151 0 01293 392" fill="none" stroke="#00aec7" strokeWidth={13.7} />
      <path
      ...
      />
      <path
        d="M274.2 197.5s-1.4-5.3-8.3-4.5c0 0 4.4-2 6.4-1 2 1.1 2.4 1.4 2 5.5m-16.8-9.4s1.5-.5 2.2-.3c0 0 1 3.3 3.2 4.5 0 0-3.8-.3-5.4-4.2m22.2 5a12.5 12.5 0 00-8.7-4.8c-1.8 0-6 3.5-6 3.5-1-2-.5-3.4-.5-3.4 2 .2 3.7 1 3.7 1-.8-2.6-2-3.8-2-3.8 4-1 8.8 2.5 8.8 2.5a16.7 16.7 0 00-11-6.8c-1.2-.1-2.7 1.6-2.7 1.6-7.8 0-9.9 4.3-9.9 4.3 3.3 5.1 10 6.3 10 6.3-11.8-1.3-11.5 8-11.5 8l10.9-5.7c-4.2 24.1-21 35-22.4 36.3-1.4 1.4-.5 3 1.5 3.2 1.1 0 2.5 1 6.2-3.4a65 65 0 0016.4-35.4l.2.2c1.2 2.9.4 5.4.6 7.3.2 1.9 4.4 6 4.4 6s2.3-4.5 2-7.1c-.5-2.7-5.5-7.6-5.5-7.6 7.8-1.5 8.2 11.6 8.2 11.6 3-3.5 2.4-7.3 2.4-7.3s6.3-4.6 4.9-6.4"
        fill="#fff"
      />
    </svg>
  );
...
export const PCFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
