...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({ svgRef, title = 'SG flag', theme, ...props }) => {
  ...
  return (
    <svg aria-hidden={ariaHidden} aria-labelledby={titleId} ref={svgRef} viewBox="0 0 640 480" {...props}>
      ...
      <g clipPath="url(#SGFlagIcon__a)" fillRule="evenodd">
        <path d="M-20 0h720v480H-20z" fill="#fff" />
        <path d="M-20 0h720v240H-20z" fill="#df0000" />
        <path
...
export const SGFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
