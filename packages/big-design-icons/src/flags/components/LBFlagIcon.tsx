...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#LBFlagIcon__a)" transform="translate(80) scale(.9375)">
        <g fillRule="evenodd" strokeWidth="1pt">
          <path d="M-128 384h768v128h-768zm0-384h768v128h-768z" fill="#EE161F" />
...
export const LBFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
