  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#KNFlagIcon__a)" fillRule="evenodd" transform="translate(75.1)scale(.9375)">
        ...
        <path d="m-108.2.2.8 368.6L466.6 0z" fill="#35a100" />
        <path d="m630.7 511.5-1.4-383.2-579 383.5z" fill="#c70000" />
        <path d="m-107.9 396.6.5 115.4 125.3-.2 611.7-410.1L629 1.4 505.2.2z" fill="#000001" />
        <path
