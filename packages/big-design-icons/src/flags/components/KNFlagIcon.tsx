  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#KNFlagIcon__a)" fillRule="evenodd" transform="translate(75.1) scale(.9375)">
        ...
        <path d="M-108.2.2l.8 368.6L466.6 0z" fill="#35a100" />
        <path d="M630.7 511.5l-1.4-383.2-579 383.5z" fill="#c70000" />
        <path d="M-107.9 396.6l.5 115.4 125.3-.2 611.7-410.1L629 1.4 505.2.2z" fill="#000001" />
        <path
