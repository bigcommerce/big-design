  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#KIFlagIcon__a)" transform="translate(81) scale(.9375)">
        ...
        />
        <path
          d="M379.5 259.6l-112.1 2.5 4.7 30.2z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M363 218.4l-103.8 39.9 17.3 33.3z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M280.6 280.7l53.7-97.6-82.4 76.7z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M279.5 272.6l17.2-109.4-53.8 97.2z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M273 263.7l-18-110.2-20 110.7z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M263.7 254.3l-52.3-92 20 111.8z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M255.6 253.6l-81.1-68.5 57.6 98z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M146 218.9l87 71.9 13.4-37.6z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
        />
        <path
          d="M232.1 260.9l-102.3-1.5 101.9 34z"
          fill="#fec74a"
          fillRule="evenodd"
          stroke="#d8aa3f"
          strokeWidth={1.7}
