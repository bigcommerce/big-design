...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <path d="M0 0h640v480H0z" fill="#3e5eb9" />
      <path d="M0 90h640v300H0z" fill="#ffd900" />
      <path d="M0 120h640v240H0z" fill="#b10c0c" />
      <g fill="#ffd900" stroke="#000" transform="translate(-43.2) scale(1.2)">
        <g id="SZFlagIcon__a">
          <path d="M492.9 154.3l-24.3 8.6 24.2 8.5 24.3-8.5z" fill="#fff" />
          <rect height={5.7} rx={3.1} ry={2.9} width={357.1} x={122.8} y={160} />
          <path d="M471.4 165.7a3 3 0 002.9-2.8 3 3 0 00-2.9-2.9m-2.8 5.7a3 3 0 002.8-2.8 3 3 0 00-2.8-2.9m-2.9 5.7a3 3 0 002.9-2.8 3 3 0 00-2.9-2.9" />
        </g>
        <use height="100%" width="100%" x={-23.3} xlinkHref="#SZFlagIcon__a" y={17.1} />
        <rect height={8.6} rx={4.2} ry={4.3} strokeWidth={1.1} width={485.7} x={59.8} y={195.7} />
      </g>
      <path
      ...
      <g stroke="#fff" transform="translate(-43.2) scale(1.2)">
        <g id="SZFlagIcon__d" strokeWidth={6.9}>
          <g id="SZFlagIcon__c">
            <path d="M214 192.4v-22.9m13.8 0v22.9m13.8-22.9v22.9" id="SZFlagIcon__b" />
            <use height="100%" width="100%" xlinkHref="#SZFlagIcon__b" y={38.1} />
          </g>
          <use height="100%" width="100%" x={41.6} xlinkHref="#SZFlagIcon__c" />
        </g>
      </g>
      <use
        height="100%"
...
export const SZFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
