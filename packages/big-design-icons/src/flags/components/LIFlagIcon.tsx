  ...
  return (
    ...
    >
      ...
      >
        <g id="LIFlagIcon__a">
          <path
            d="M216.4 122.3l-1.9 62.5h-63.4c-7.8-15.2-14.2-28-14.2-45.5 0-14.6 11.5-26.2 28-26.2 17.5 0 36.8 5.9 51.5 9.2"
            stroke="none"
          />
          <g strokeWidth={1.5}>
          ...
          <path d="M215 119.5l-.5 6.5c-12.3-2-29.7-8.8-46-8.8-15 0-26.6 6-26.6 21.2 0 14.9 6.3 28.5 14.7 42.3l-8.7 4c-7.8-15-14.3-28-14.3-45.4 0-14.6 11.5-29 31.3-29 17.5 0 35.4 6 50.1 9.2" />
        </g>
        <use
          height="100%"
        ...
        />
        <path d="M222 53.1l-5.2 9.7 5.2 9.6 5.1-9.6L222 53zm0 24.4l-5.2 9.6 5.2 9.7 5-9.8zM203.6 75l8.1 5.1 8.1-5.1-8-5.2zm20.5 0l8.1 5.1 8.2-5.1-8.2-5.2z" />
        ...
        <path
          ...
          strokeWidth={1.5}
        />
        <path d="M211.8 117.7c-1 17-3 34.5-9.7 47.1l10.8-4.4c3.8-14.3 4.6-32.8 5.7-41.6zm20.4 0l-6.9 1.1c1.2 8.8 2 27.3 5.7 41.6l10.8 4.4c-6.6-12.6-8.6-30-9.6-47.1" />
...
export const LIFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
