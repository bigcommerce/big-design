  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#c8a400"
      />
      <g clipPath="url(#NIFlagIcon__c)" transform="translate(-80)scale(.8)">
        <path d="m500 226.4-31.5 54.5-15.4 26.7h93.8l-14.7-25.4z" fill="#fff" />
        <g id="NIFlagIcon__e">
          <g id="NIFlagIcon__d">
            <path
        ...
        <g fill="url(#NIFlagIcon__h)">
          <path d="m453.1 307.6-10 17.3H557l-10-17.2h-93.8z" fill="#fff" />
        ...
        <g fill="#ccd11e">
          ...
          <g fill="#c6cb24">
            ...
            <path d="M493.8 309.3a31 31 0 0 1-8.8 10h-2.8c2.5-.2 8.2-5 11.6-10" fill="#9ecb34" />
            <path
        ...
        <path
          ...
          fill="#97c924"
        />
        <path d="m550 324.6 4 .3a91 91 0 0 0 2.9.3l-.4-.5c-.6.2-4.4-.2-6.4 0z" fill="#fff" />
      </g>
      <path
