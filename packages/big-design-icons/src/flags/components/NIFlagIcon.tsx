    ...
    >
      ...
      <g clipPath="url(#NIFlagIcon__c)" transform="matrix(.8 0 0 .8 -80 0)">
        ...
        <g id="NIFlagIcon__e">
          ...
          <use width="100%" height="100%" transform="rotate(72 500 285.5)" xlinkHref="#NIFlagIcon__d" />
          <use width="100%" height="100%" transform="rotate(144 500 285.5)" xlinkHref="#NIFlagIcon__d" />
          <use width="100%" height="100%" transform="rotate(-144 500 285.5)" xlinkHref="#NIFlagIcon__d" />
          <use width="100%" height="100%" transform="rotate(-72 500 285.5)" xlinkHref="#NIFlagIcon__d" />
        </g>
        <use width="100%" height="100%" transform="rotate(8 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <use width="100%" height="100%" transform="rotate(16 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <use width="100%" height="100%" transform="rotate(24 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <use width="100%" height="100%" transform="rotate(32 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <use width="100%" height="100%" transform="rotate(40 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <use width="100%" height="100%" transform="rotate(48 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <use width="100%" height="100%" transform="rotate(56 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <use width="100%" height="100%" transform="rotate(64 500 285.5)" xlinkHref="#NIFlagIcon__e" />
        <path
          fill="red"
        ...
        <g fill="url(#NIFlagIcon__h)">
          ...
          <g id="NIFlagIcon__o" fill="url(#NIFlagIcon__i)">
            <path
              id="NIFlagIcon__l"
            ...
            />
            <use width="100%" height="100%" y={-1.1} fill="url(#NIFlagIcon__k)" xlinkHref="#NIFlagIcon__l" />
            <use width="100%" height="100%" y={-2.2} fill="url(#NIFlagIcon__m)" xlinkHref="#NIFlagIcon__l" />
          </g>
          <use width="100%" height="100%" y={-3.3} fill="url(#NIFlagIcon__n)" xlinkHref="#NIFlagIcon__o" />
          <use width="100%" height="100%" y={-6.7} fill="url(#NIFlagIcon__p)" xlinkHref="#NIFlagIcon__o" />
          <path
          ...
          />
          <path fill="url(#NIFlagIcon__r)" d="M457.4 312.3c3.4.7 3.7 0 3.7 0zm81.5 0s.3.7 3.7 0z" />
        </g>
        <g fill="#ccd11e">
          <g id="NIFlagIcon__t">
            <path
          ...
          <use width="100%" height="100%" x={-15.3} xlinkHref="#NIFlagIcon__t" />
          <g fill="#c6cb24">
            <path
          ...
          <use width="100%" height="100%" x={-15.4} fill="#c6cb24" xlinkHref="#NIFlagIcon__w" />
        </g>
        <path
          fill="#fff"
        ...
        <g id="NIFlagIcon__A">
          ...
          />
          <use width="100%" height="100%" y={-1.3} xlinkHref="#NIFlagIcon__z" />
          <use width="100%" height="100%" y={-2.6} xlinkHref="#NIFlagIcon__z" />
        </g>
        <use width="100%" height="100%" y={-3.9} xlinkHref="#NIFlagIcon__A" />
        <use width="100%" height="100%" y={-7.7} xlinkHref="#NIFlagIcon__A" />
        <path
          fill="#97c924"
