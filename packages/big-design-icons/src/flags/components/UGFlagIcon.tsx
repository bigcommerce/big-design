  ...
  return (
    <svg viewBox="0 0 640 480" ref={svgRef} aria-labelledby={titleId} {...props}>
      ...
      <g clipPath="url(#UGFlagIcon__a)" transform="translate(80) scale(.9375)">
        ...
        />
        <path fill="#fff" fillRule="evenodd" d="M247.2 203a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
        <path
          fill="#de3108"
          fillRule="evenodd"
          stroke="#000"
        ...
        />
        <path fill="none" stroke="#fff" strokeLinecap="round" strokeWidth={0.9} d="M228.4 209.9s10.5-2.6 11.8-2.2" />
