    ...
    >
      ...
      <defs>
        <clipPath id="ZMFlagIcon__a">
          <path d="M-170.7 0H512v512h-682.7z" fillOpacity={0.7} />
        </clipPath>
      </defs>
      <g clipPath="url(#ZMFlagIcon__a)" fillRule="evenodd" transform="translate(160) scale(.9375)">
        <path d="M-256 0h768v512h-768z" fill="#198a00" />
        <path d="M421.9 184H512v328h-90.1z" fill="#ef7d00" />
        <path d="M331.9 183.8h90v328h-90z" fill="#000001" />
        <path d="M240 184h91.9v328h-92z" fill="#de2010" />
        <g fill="#ef7d00" stroke="#000">
          ...
          <path
            ...
            strokeWidth={1.1}
          />
          <path d="M371.9 57.5c0-.4-1.7-4-7.8.4 3.3.2 6.5 2.1 7.8-.4z" strokeWidth={1.1} />
          <path
            ...
            strokeWidth={1.1}
          />
          <path d="M434.7 90.7c-2 .3-8.3.3-9.2.1" strokeLinecap="round" strokeWidth={1.1} />
          <path
...
export const ZMFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
