...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({ svgRef, title = 'IO flag', theme, ...props }) => {
  ...
  return (
    <svg aria-hidden={ariaHidden} aria-labelledby={titleId} ref={svgRef} viewBox="0 0 640 480" {...props}>
      ...
      <g clipPath="url(#IOFlagIcon__a)" transform="scale(.9375)">
        <path d="M0 0h1024v512H0z" fill="#fff" fillRule="evenodd" />
        <path
          ...
          fillRule="evenodd"
        />
        <path d="M0 0h261.3v158H0z" fill="#000063" fillRule="evenodd" />
        <g strokeWidth="1pt">
          <path d="M0 0v17.7L232.1 158h29.2v-17.7L29.3.1H0zm261.3 0v17.7L29.3 158H0v-17.7L232.1.1h29.2z" fill="#fff" />
          <path d="M108.9 0v158h43.5V0H109zM0 52.8v52.6h261.3V52.7H0z" fill="#fff" />
          <path
