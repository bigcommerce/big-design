  ...
  return (
    ...
    >
      ...
      <g transform="translate(-217.5 -9.4) scale(.77497)">
        <path
          d="M776.3 144l250.4-.9-.5 223s8.8 34-105 85.5c40.9-4.2 85.5-47.8 85.5-47.8s18.1-23.3 27-10.3c8.8 13 17.1 19.6 23.6 24.7 6.5 5 11.6 19 1.9 29.2-9.8 10.3-25.1 11.6-29.3-.9-6.5 3.3-46.4 51.6-128.2 53.9C818.5 499 773 446 773 446s-11.1 17.7-27 3.8c-15.3-18.2-3.7-29.8-3.7-29.8s13-7.4 16.8-12.5c6-7 7.9-16.3 18-16.3 12.2 1 16.8 10.7 16.8 10.7s41.8 44.1 86.9 49.7c-101.7-48.8-105.5-79-105-86.4z"
          fill="#fff"
        />
        <path
          d="M782.3 150.1l238.8-1.4v214.6c.5 28-46.5 56.3-119.9 92.5-75.7-39-119.4-62.7-119.8-93z"
          fill="#006129"
          stroke="#000"
          strokeWidth={1.9}
        />
        <g fill="#ffc72c" id="VGFlagIcon__b" stroke="#000" strokeWidth={0.9}>
          <path d="M814.8 181.8l14-20.7 14.3 20.8" fill="none" stroke="#ffc72c" strokeWidth={1.9} />
          <path d="M831.7 174a2.8 2.8 0 11-5.6 0 2.8 2.8 0 015.6 0z" />
          <path d="M817.4 197.1h21.9s.3-2.8-2.3-4.5c11.5-1.6 8.5-11.6 18-12.2 2 .3-5 4.3-5 4.3s-5.7 4-3 6.1c2 1.7 3-1 3.2-3 .3-2 9.3-3.3 8-9-2.1-4.7-14.7 3.2-14.7 3.2l-9-.1c-.6-1-3-5-5.6-5-3 0-5.2 5-5.2 5h-20.3s-.7 5.3 9.6 6.3c2.3 3 4.1 3.8 6.2 4.6-1.4 1.1-1.8 2.5-1.8 4.3zm1.6-4.4h18.2M810.7 182s1.4 8.5 8.2 10.5" />
          <path
          ...
          />
          <path d="M831.5 161.7a2.6 2.6 0 11-5.2 0 2.6 2.6 0 015.2 0z" />
        </g>
        <use height="100%" width="100%" x={-0.8} xlinkHref="#VGFlagIcon__b" y={41.3} />
        <use height="100%" width="100%" x={-1.1} xlinkHref="#VGFlagIcon__b" y={82} />
        <use height="100%" width="100%" x={25.6} xlinkHref="#VGFlagIcon__b" y={126.1} />
        <use height="100%" width="100%" x={-4.6} xlinkHref="#VGFlagIcon__b" y={162.2} />
        <use height="100%" width="100%" x={-3.8} xlinkHref="#VGFlagIcon__b" y={204.8} />
        <use height="100%" width="100%" x={146.3} xlinkHref="#VGFlagIcon__b" y={0.7} />
        <use height="100%" width="100%" x={144.9} xlinkHref="#VGFlagIcon__b" y={41.2} />
        <use height="100%" width="100%" x={143.1} xlinkHref="#VGFlagIcon__b" y={82.7} />
        <use height="100%" width="100%" x={145.2} xlinkHref="#VGFlagIcon__b" y={123.4} />
        <use height="100%" width="100%" x={144.7} xlinkHref="#VGFlagIcon__b" y={164.2} />
        <use height="100%" width="100%" x={144.9} xlinkHref="#VGFlagIcon__b" y={205.2} />
        <g fill="#ffc6b5" stroke="#000" strokeWidth={0.9}>
          <path
            d="M915.8 406.3s5.7 13.2 12.2 5c6.5-8 4.2-11.5 4.2-11.5l-14.6-7.9-4.3 9z"
            fill="#ffc72c"
          />
          <path d="M928.4 404.6s1 .1 1.7-1.3c.8-1.4-1.7-2-2.9-3.6l-1.2 2.5zm-33-3.6l-12.8 7s-6.4 1.3-6.8 0c-.5-1.2.1-2.3 3.5-2.5 3.3-.1 12.3-8.4 12.3-8.4l3.8 4zm.2-227.9l.4 4.6c.2 1.6-2.5 5-2.6 4.8-.2-.2-1.5.2-1.3 1.1.1 1 2 1.3 2 1.3s-.7 3.3 0 3.5c.8.1-2 4.2 0 5.3 2.1 1.1 5.6 2.6 7.2 2.3 1.6-.4 0 6.1 0 6.1l-4.5 9.5 24.4-2.5-5-8s-2.4-1.7-1.8-6.3c.7-4.5-.3-25.3-.3-25.3l-17.4-2.4zm-4.5 36.2s-7.9 3.6-7.6 13.4c-2 9.5-3.1 19-3.1 19s-9.4 10.6-12.2 14.5c-2.9 3.8-7.2 11.5-8.7 13.6-1.6 2-7.8 8.8-7.7 11.4.2 2.5-1.4 13.8 4.8 15 1.6.7 6.7-13 6.7-13s.3-5.8-1.5-7c-1.7-1 3.8-4.8 3.8-4.8l13-9.7c2.4-2 8.9-9.2 8.9-9.2z" />
          <path
          ...
          />
          <path
            d="M897.8 403s-15.4 8-17.6 8.7c-2.2.6-3.6-2.7-1.4-3.3 2.2-.7 5.7-1 5.7-1s-5.2-4.1-5-4.3l7.2-2.6c.2 0 2.2 4 3.6 3.8a31 31 0 005.6-3.5z"
            fill="#ffc72c"
          />
          ...
          />
          <g fill="none">
            <path d="M920.8 208s-14.1 9-13.8 12.2m17-10.6s-3.2 3.5-3.4 3.5m7.6.3s-7 5.7-5.9 9.3m-27-15.5s-2.1 4.3-1.6 5.7c.4 1.4 4 6.8 4.4 10.1.5 3.4 0 5.7 0 5.7m-6.5-13.6s.6 5 1.6 6 3.5 5.3 3.8 7m-6.7 8.1s4.2 2 8-5.9m6.1-5.5c-.1 0-3 7.7 2.1 10.6 5 2.9 8.9 2.5 11 1.7 2.3-.7 4.7-2.2 4.7-2.2m-20-.6s.3 10.4 15.7 20.7m-15-10.9s-.2 9.2 5.8 13.3m-9-24.1s-4.6 13.7-8.3 15m6.9-5s-.2 9.8-1.5 13.3m-1.2 2.4s3.1 4 6.6 3.6c3.5-.3 5-4.4 7.3-3.8 2.4.7 4.6 2.6 10.1 2.1m-7.9 4.1s0 8.1 1.5 8.9c1.4.8.7 8.2.7 8.2m-21.5-20.9s-.2 7.6-1.1 10.3c-1 2.7-2.9 7.3-2.5 11.3m-6.1 4.4c.8-.3 3.5-2.7 3.5-2.7m1.4 1.7s-6.8 29.2-4.9 46.6m6.5-45.1s-3.5 21.8-1.9 26m.2-26.7l13.3 1m1.9-1.8s3.6 2 8.7 1.6m-10.3 9.1s-.6 37.3-1.6 45.6m21.1-37.1s4.1 32.8 6.5 35.8m-14.4-31.7s2.5 29 4 31.6m-40 10.1s5-1.6 9.4-6.3c5 6.8 12.8.3 12.8.3s12 8.2 17.4-1c8.3 5.4 12.4-.8 12.4-.8s3 4.6 5.2 4.1m-13.1 3.2s6.1 29 15.3 37.2" />
