...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({ svgRef, title = 'JE flag', theme, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#JEFlagIcon__a)" transform="matrix(.75 0 0 .75 3.975 4.5)">
        ...
        <g transform="translate(-9.7 -6) scale(.20361)">
          ...
          <g id="JEFlagIcon__b" stroke="#000">
            ...
            />
            <path strokeWidth={0.1} d="M113 26.5l-1-.3m1 .3h-1m1 .1l-.9.3m1.7-.4l1-.3m-1 .3h1.2m-1.2.1l1 .3" />
            <path
              fill="#0051ba"
              strokeWidth={0}
          ...
          <use width={30} height={18} transform="matrix(.9 0 0 .9 11.6 13.7)" xlinkHref="#JEFlagIcon__b" />
          <use width={30} height={18} transform="matrix(.67 0 0 .75 39.2 27.5)" xlinkHref="#JEFlagIcon__b" />
        </g>
      </g>
    </svg>
  );
