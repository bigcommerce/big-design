    ...
    >
      ...
      >
        <g id="UYFlagIcon__c">
          <g id="UYFlagIcon__b">
            <g id="UYFlagIcon__a">
              <path strokeLinecap="square" d="M1.5 9L6 12c-8 13 1 15-6 21 3-7-3-5-3-17" transform="rotate(22.5)" />
              <path fill="none" d="M0 11c-2 13 4.5 17 0 22" transform="rotate(22.5)" />
              <path d="M0 0h6L0 33-6 0h6v33" />
            </g>
            <use width="100%" height="100%" transform="rotate(45)" xlinkHref="#UYFlagIcon__a" />
          </g>
          <use width="100%" height="100%" transform="rotate(90)" xlinkHref="#UYFlagIcon__b" />
        </g>
        <use width="100%" height="100%" transform="scale(-1)" xlinkHref="#UYFlagIcon__c" />
        <circle r={11} />
      </g>
      <g transform="translate(133.3 133.3) scale(.29333)">
        ...
        <use width="100%" height="100%" transform="scale(-1 1)" xlinkHref="#UYFlagIcon__d" />
