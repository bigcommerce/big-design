  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#BIFlagIcon__a)" fillRule="evenodd" transform="translate(84.9)scale(.9375)">
        <path d="m-178 0 428.8 256L-178 512zm857.6 0L250.8 256l428.8 256z" fill="#18b637" />
        <path d="m-178 0 428.8 256L679.6 0zm0 512 428.8-256 428.8 256z" fill="#cf0921" />
        <path d="M679.6 0h-79.9L-178 464.3V512h79.9L679.6 47.7z" fill="#fff" />
        <path d="M398.9 256a148 148 0 1 1-296.1 0 148 148 0 0 1 296 0z" fill="#fff" />
