...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M316 243.7a1.8 1.8 0 101.8 2.9 4 4 0 002.2.6h.2c.6 0 1.6-.1 2.3-.6.3.5.9.7 1.5.7a1.8 1.8 0 00.3-3.6c.5.2.8.6.8 1.2a1.2 1.2 0 01-2.4 0 3 3 0 01-2.6 1.7 3 3 0 01-2.5-1.7c0 .7-.6 1.2-1.3 1.2-.6 0-1.2-.6-1.2-1.2s.3-1 .8-1.2zm2 5.4c-2.1 0-3 2-4.8 3.1 1-.4 1.8-1.2 3.3-2 1.4-.8 2.6.2 3.5.2.8 0 2-1 3.5-.2 1.4.8 2.3 1.6 3.3 2-1.9-1.2-2.7-3-4.8-3-.4 0-1.2.2-2 .6l-2-.7z"
        fill="#85340a"
      />
      <path
      ...
      <path
        ...
        fill="#85340a"
      />
      <path d="M323.7 258.9a3.7 3.7 0 00-7.4 0 3.8 3.8 0 017.4 0z" fill="#85340a" />
      <path
