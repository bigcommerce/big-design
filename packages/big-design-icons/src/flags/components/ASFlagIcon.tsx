...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({ svgRef, title = 'AS flag', theme, ...props }) => {
  ...
  return (
    <svg viewBox="0 0 640 480" aria-hidden={ariaHidden} ref={svgRef} aria-labelledby={titleId} {...props}>
      ...
      <g clipPath="url(#ASFlagIcon__a)">
        <path fill="#006" d="M-374-16H650v512H-374z" />
        <path fill="#bd1021" fillRule="evenodd" d="M-374 240L650 496V-16L-374 240z" />
        <path fill="#fff" fillRule="evenodd" d="M650 11.4v457.2L-264.3 240 650 11.4z" />
        <g stroke="#000">
          <path
            fill="#9c3900"
            fillRule="evenodd"
          ...
          />
          <path fill="none" strokeWidth={1.6} d="M373.4 230.4a4.8 4.8 0 11-9.6 0 4.8 4.8 0 019.6 0z" />
          <path
            fill="#fff"
            fillRule="evenodd"
            strokeWidth={1.9}
          ...
          />
          <path fill="none" strokeWidth={1.9} d="M436.2 151.5s27.2-14 31.5-15.6c4.3-1.5 14-13.8-.6-13.8" />
          <path fill="none" strokeWidth={1.9} d="M449.4 157c.3 0 22.3-14.4 29.6-16.2 4-5.5 1.8-11.3-4.9-10.1" />
          <path
            fill="none"
            strokeWidth={1.9}
