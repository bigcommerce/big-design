  ...
  return (
    ...
    >
      ...
      <g fill="#009b3a" stroke="#000" strokeWidth={0.1}>
        ...
        <path d="M339.7 219.2l-1 .6c-.3 0-.6-.3-1.2 0s-1 .9-1.1 1.2c-.1.3.2.5.9.1.7-.3.9-.9 1.2-1.1l1.3-.7.8-1.3c.3-.4 1.2-1 1.6-1.8.3-.6.2-1.1-.2-.9a3 3 0 00-1.2 1.3c-.2.4 0 1-.3 1.4zm7.3 2.4a1 4.8-1.6 11-2.2-.5 1 4.8-1.6 112.2.5z" />
        ...
        <path d="M345.6 226.4l-1.8.4c-.3 0-.6-.7-1.5-.5-.9.2-1.7.8-2 1.2-.2.4.1.8 1.2.6 1.2-.2 1.6-1 2.2-1 .5-.2 1.4-.4 2-.4.2-.4 1-1.2 1.5-1.6.5-.5 2-1 2.7-1.8.7-.8.7-1.6 0-1.5a4.8 4.8 0 00-2 1.3c-.5.6-.4 1.5-.9 2zm5.1 4.9a1 4.8 8.7 11-2-1 1 4.8 8.7 112 1z" />
        ...
        <path d="M310.8 262l-10.2-1.7 10 4 1.8-.7z" />
        <path d="M312.5 262.5l-10 .2 10.2 2.3 1.6-1.1z" />
        <path d="M305.7 256c2.8 2.6 7 6.8 9.9 9.2-3.3.7-8.3 2.4-11.3 3.4 2.4-1.3 5.8-2.9 7.7-4.5-1.6-2.5-4.4-5.7-6.3-8.2z" />
        <path d="M313.9 262.9l-10.2-2.6 9.8 5 1.9-.6z" />
      ...
      <path
        d="M327.6 249.5l-7.6-5.3-7.6 5.3 2.9-8.4-6.7-5.2h8.6l2.8-8.4 2.8 8.4h8.6l-6.7 5.2z"
        fill="#fedf00"
        stroke="#000"
        strokeWidth={0.4}
      />
