    ...
    <svg aria-hidden={ariaHidden} aria-labelledby={titleId} ref={svgRef} viewBox="0 0 640 480" {...props}>
      ...
      <defs>
        <clipPath id="FMFlagIcon__a">
          <path d="M-81.3 0h682.6v512H-81.3z" fillOpacity={0.7} />
        </clipPath>
      </defs>
      <g clipPath="url(#FMFlagIcon__a)" fillRule="evenodd" strokeWidth="1pt" transform="translate(76.3) scale(.94)">
...
export const FMFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
