  ...
  return (
    ...
    >
      ...
      <g fill="#ffe000" transform="translate(0 80) scale(.0635)">
        <use width="100%" height="100%" x={7560} y={4200} xlinkHref="#CCFlagIcon__a" />
        <use width="100%" height="100%" x={6300} y={2205} xlinkHref="#CCFlagIcon__a" />
        <use width="100%" height="100%" x={7560} y={840} xlinkHref="#CCFlagIcon__a" />
        <use width="100%" height="100%" x={8680} y={1869} xlinkHref="#CCFlagIcon__a" />
        <use width="100%" height="100%" x={8064} y={2730} xlinkHref="#CCFlagIcon__b" />
      </g>
    </svg>
  );
};
