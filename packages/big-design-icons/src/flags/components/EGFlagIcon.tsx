    ...
    >
      ...
      <g fill="#fff" stroke="#c09300" transform="matrix(.8 0 0 .8 -40 0)">
        ...
        <path
          ...
          stroke="none"
        />
        <use height="100%" transform="matrix(-1 0 0 1 900 0)" width="100%" xlinkHref="#EGFlagIcon__a" />
        <path
        ...
        <g fill="none" id="EGFlagIcon__b" strokeLinejoin="round" strokeWidth={1.3}>
          <path d="M428.5 295.8l-19.1 67.7 26.3 4 11.1-50.9-18.3-20.8z" fill="#fff" strokeWidth={1.2} />
        ...
        <use height="100%" transform="matrix(-1 0 0 1 900 0)" width="100%" xlinkHref="#EGFlagIcon__b" />
