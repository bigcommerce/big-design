...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <path d="M640 480V0H0v480z" fill="#002868" />
      <g fill="none" stroke="#000">
        ...
        <g strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2}>
          <path
            d="M447.1 273.7c-2.7 4.7-7.4 5.7-11 4.2-3.7-1.5-7.1-10.3-10.9-15-3.6-4.7-4.6-2.7-7-5.4a37.6 37.6 0 00-12-7.4c-3.3-1.5-6.7-2.9-9-8.6a9.8 9.8 0 015.2-5.1c1.9-.7 3.4-3.4 3.6-5.8.3-2.2 2.3-4.7 5-6.6-1.3.2-3.9-.3-5.1-1.1-1.1-1-3-.8-4.1 0-1.2.8-2.6 1-4.6.8.8-.6 2.2-2 2.3-3.2s1.6-1.9 4.5-1.9c2.8 0 4.6-3.2 6.9-3.2-1.6 0-1.3-2.8-.4-3-4-.7-3.5-4-1.9-4-.1-.4-.6-1-2.5-1.5-1.7-.7-.9-2.3.5-3.3-1.2-2.5-.1-4.4 1.9-6-2.8-.1.3-4 1-6.1.8-2 1.1-2.3 2-1 1 1.1 3.3 3.7 5.9 4.5 2.5.7 4 2.1 4.5 4.2.5 2.3 1.5 3.4 4.2 4.4 2.9.9 6.8 3.3 6.3 8.6a9 9 0 015.2 1.9"
            fill="#fcad56"
            strokeWidth={0.3}
          />
          <path
            d="M454 206a8 8 0 003.1 6.4c1.9 1.5 3.5 2.7 3.1 4.6-.3 2 .4 3.2 2 4.5 1.8 1.2 3 2.7 2.6 5.2s-.2 4 .8 5.9 2.8 3.4 2 6.4-.4 7 .6 9c1 1.9 0 3.4-1.7 6.7-1.8 3.3-2.8 4.5-6.4 5.8-3.7 1.1-4 3.4-4 7.2 0 4-2.6 6-7.5 5.3-5 4.1-8.1-.8-9.4-6.9s-1.4-12.8-8.8-18.1c-7.3-5.5-4.4-14.8 1.7-18.5 6.1-3.6 5.4-14.4 4.6-21-.6-6.6 3.8-10.4 7.2-14 4.5 1.7 10.1 8.6 10.1 11.5"
            fill="#ffa1a1"
            strokeWidth={0.3}
          />
          <path
          ...
          <g fill="#9e540a" transform="matrix(.125 0 0 .125 535 249.6)">
            ...
            <use height="100%" transform="scale(-1 1)" width="100%" xlinkHref="#TCFlagIcon__b" />
            <g id="TCFlagIcon__c">
            ...
            <use height="100%" transform="scale(-1 1)" width="100%" xlinkHref="#TCFlagIcon__c" />
          </g>
          <g transform="matrix(.125 0 0 .125 485 299.6)">
            ...
            <use height="100%" transform="scale(-1 1)" width="100%" xlinkHref="#TCFlagIcon__d" />
