...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <path d="M477.6 259l2.1-.6-14-48h-.4z" fill="#784421" stroke="#000" strokeWidth={1.2} />
      ...
      />
      <path
        d="M461.6 196.7l5.7 1.9s5.4 2.3 12.3 0l5.2-2-3.5 5.4v2.9l2.1 3.2s-1.3.6-5.4-2c0 0-4.4-3.4-9.6 0 0 0-3 2-5.4 2l3.5-3.8-1.3-3.5-3.6-4.3z"
        fill="#f5ce00"
        stroke="#000"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M484.8 204.4s0 .8-.8 1c0 0-1 .3-1.5-.9v-.3c0-.5-.3-2 1.4-3.3 0 0 2.6-2.1 7.6.5a192 192 0 0014.8 7.5s3.1 1.6 7.9 1.8c0 0 6.5.5 9.3-4.1 0 0 2.1-3.5 0-5.8 0 0-.9-1-2.3-.8a3 3 0 00-1.8 1.2s-1 1.4.1 2.5c0 0 1.6 1 2.2-1 0 .2.5 1.7-.4 2.9 0 0-4 6-14.9-.1l-14.3-8.1s-7.1-3.7-11.6 2.1c0 0-3.4 4.8 1.1 7.9 0 0 3.4 2 5.4-1.2 0 0 1.8-3.1-1-4.4 0 0-2.4-1.2-3.3 1.2-1 2.4 1.8 3 2 1.3 0 0 0-.4.3 0z"
        fill="#f5ce00"
        stroke="#000"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M491.6 240.4l1.2-1.5 2.5-2s4 10.4 4.2 12.7v3.2s6 1.6 7.2 10.7l-5 9.2-7.8-4.4-2.3-1.5v-26.3z"
        fill="#784421"
        stroke="#000"
        strokeWidth={1.2}
      />
      ...
      />
      <path
        d="M443.8 227.4l6 47.8m-4.5-47.9l6.6 44.6m-5.5-44.8l7.8 44.2"
        fill="none"
        stroke="#000"
        strokeMiterlimit={10}
        strokeWidth={1.2}
      />
      <path d="M458.6 267.5l2.2-.7-14-48h-.5z" fill="#784421" stroke="#000" strokeWidth={1.2} />
      <path
        d="M450.7 225.3l14.1 35.5m-15-35l13.6 37"
        fill="none"
        stroke="#000"
        strokeMiterlimit={10}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M451.5 224.8l14.3 32.4m-18.3-30.4l9 43.7"
        fill="none"
        stroke="#000"
        strokeMiterlimit={10}
        strokeWidth={1.2}
      />
      <path
        d="M520 259c-6.3-3.6-7.7-11.4-7.7-11.4a24.6 24.6 0 011.6-14.3c4-8.6 11.1-10.3 11.1-10.3s-6.9 4.8-8.8 11.2c0 0-1.4 5.5-.6 10.7.8 5.5.5 4.1 1.8 8.3l2.6 6z"
        fill="#f5ce00"
        stroke="#000"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      />
      <path
        d="M492.7 238.7l-26.6 8.5-1.4 12c-6.3 9.1-19.2 10.7-19.2 10.7l10 10.7 19 4 10.2-7.8 9.2-8.4c-1-4.5-.5-11.2-.5-11.2 0-1.2.5-3.8.5-3.8s-1.5-10.7-1.2-14.5z"
        fill="#784421"
        stroke="#000"
        strokeWidth={1.2}
      />
      ...
      />
      <path
        d="M499.5 252.8l-6 4.4s-24.5 11.2-43.2 11.6m43.1-3.6S474.6 275 464 275"
        fill="none"
        stroke="#000"
        strokeMiterlimit={10}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M527 263.3c-10.2-3.2-13-14.3-13-14.3a25.5 25.5 0 011.2-15.5c4.8-11 12.7-11 12.7-11a4 4 0 014.5 3.2c.4 2.4-1.3 3.3-1.3 3.3-2.7 1.5-4.5-.5-4.5-.5-1.2-1.6-.3-2.9-.3-2.9.7-1 2-.4 2-.4 1.3.2 1 1.6 1 1.6s.4-1.6-1.2-1.8c0 0-3.2-.7-6.8 3.8 0 0-4.7 6.1-4.7 14.1 0 0-.6 14.8 14.7 18.6 0 0-1.6 2.4-4.6 11.1 0 0-3.3 11.2-6.4 17.3 0 0-4.3 8.6-13.9 5.1 0 0-5.6-2.5-5.6-6.5 0 0-.3-3.8 3-4 0 0 3.3-.3 3.3 2.5 0 0 0 3-3.5 2.4 0 0-1.2-.3-1.1-1.5 0 0 .2-1.2 1.8-.6 1.5.6 0 0 0-.1 0 0-.6-.3-1.2 0 0 0-.6 0-.6 1 0 0 0 .6.7 1.1l1.7.2s1 2 3 2.7a8 8 0 007.1-1.2 10.7 10.7 0 003-4.3 113.3 113.3 0 005.2-13.5s1.8-5.7 3.4-8.7z"
        fill="#f5ce00"
        stroke="#000"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M419.3 263.3c10.3-3.2 13-14.3 13-14.3a25.5 25.5 0 00-1.1-15.5c-4.8-11-12.7-11-12.7-11a4 4 0 00-4.5 3.2c-.3 2.4 1.3 3.3 1.3 3.3 2.8 1.5 4.6-.5 4.6-.5 1.1-1.6.2-2.9.2-2.9-.7-1-2-.4-2-.4-1.2.2-1 1.6-1 1.6s-.3-1.6 1.2-1.8c0 0 3.2-.7 6.8 3.8 0 0 4.8 6.1 4.8 14.1 0 0 .6 14.8-14.8 18.6 0 0 1.7 2.4 4.6 11.1 0 0 3.4 11.2 6.6 17.3 0 0 4.2 8.6 13.7 5.1 0 0 5.6-2.5 5.6-6.5 0 0 .4-3.8-3-4 0 0-3.3-.3-3.3 2.5 0 0 0 3 3.6 2.4 0 0 1.2-.3 1-1.5 0 0-.2-1.2-1.7-.6-1.6.6 0 0 0-.1 0 0 .5-.3 1.1 0 0 0 .6 0 .6 1 0 0 0 .6-.7 1.1l-1.5.2s-1 2-3.2 2.7a7.5 7.5 0 01-7-1.2 10.7 10.7 0 01-3-4.3 113.5 113.5 0 01-5.3-13.5s-1.8-5.7-3.2-8.7l-.6-1.2z"
        fill="#f5ce00"
        stroke="#000"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M448.2 291.4s-2.1-.4-3.4 2.2c0 0-.7 1.5-.9 2.5m-.7-9s2.2.3 1.1 3.4c-1.2 2.9-3 3.7-3.6 4.2m27.4-91.1s5.2-3.3 10.4.3m-39.7 31.3s.7-3-2.6-8c0 0-2.2-4.7-3.2-7.5m7.4-3.3l2.3 6.6 3 6.8"
        fill="none"
        stroke="#000"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M443.1 226.6l.4.8s6 .3 9.1-3.8l-.3-.8s-5.3-.3-9 3.8z"
        fill="#784421"
        stroke="#000"
        strokeWidth={1.2}
      />
      <path
        ...
        strokeWidth={1.2}
      />
      <path d="M462.5 220.5l-.2-.6 10.1-4 .3.8z" fill="#784421" stroke="#000" strokeWidth={1.2} />
      <path
        d="M463.4 220.1l6.8 33.3m-5.6-33.6l7.7 33m-6.4-33.6l8.4 32.9m-5-34.1l11.5 24.6m-10-25l12.3 24.2M471.8 217l13.4 24.3m-15.5 12.4l5.2-1.6m-9.1-1.6s15.2-4.5 27-9.2M465.4 252s19.5-5 27.2-8.8m-21.2 24.6l1 3.3 2.8-1-1-3.1m5-1.3l1 3 2.8-.9-1-3m-16-17.6l-.2-4.2 25.5-7.7 1.3 3.6m-16 .8l1.3 3.8m7.6-6.4l1.6 3.6m.5-4.3l1.6 3.3m.4-4l1.6 3.6m0-4l2.8-1.6 1.2 3.1m-2.6-2.3l1.4 3.3"
        fill="none"
        stroke="#000"
        strokeMiterlimit={10}
        strokeWidth={1.2}
      />
      <path
        d="M429.5 283.1s-5-5.1 0-10c0 0-5.5-2.6-4.6-7m13.6 21s-5.3.7-3.7-9.4c0 0-2.2 4-2.9 6a4.7 4.7 0 002 5.4c.9.6 5.5 1.8 7-1.2m-8.3-16.2s-2.1 1.9-.6 5.4m2.8-5s.2 3.5 2 5.4m-.5-6.7s0 4 2.9 6.6m-1.5-8s0 4.5 3.4 7.4m13.5-.7s1.6-3.9 5.2-3.6c0 0-1.7.8-1.7 2.5 0 0-.2 3 2.9 3.2 0 0 2.5.4 3.8-1"
        fill="none"
        stroke="#00247d"
        strokeMiterlimit={10}
        strokeWidth={1.2}
      ...
      <path
        d="M526 205.6s.8-1.2.5-4.4c-.4-3.2 2.6-3.7 3.6-2.8 0 0 1.2 1 0 3.1a8.3 8.3 0 01-4.1 4.1z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      <path
        d="M525.1 204.4s0-1.4-2.3-3.6c-2.4-2.4-.5-4.4 1-4.4 0 0 1.3 0 2 2.3a8.3 8.3 0 01-.7 5.7z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M522 203.3s-.7-1-3.5-2.1c-2.9-1-2.2-3.5-1-4 0 0 1.3-.5 2.6 1.1a7.6 7.6 0 011.8 5z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M523.7 204.4s-1.3.5-4.4-1c-3.1-1.5-4.4 1.1-3.8 2.3 0 0 .5 1.6 2.8 1.2a8.3 8.3 0 005.4-2.4z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M420.2 205.6s-.8-1.2-.5-4.4c.4-3.4-2.5-3.7-3.5-2.8 0 0-1.2 1-.2 3.1a8.3 8.3 0 004.2 4.1z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      <path
        d="M421.2 204.4s0-1.4 2.4-3.6c2.3-2.4.4-4.4-1-4.4 0 0-1.6 0-2 2.3a8.3 8.3 0 00.6 5.7z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M424.3 203.3s.6-1 3.5-2.1c2.8-1 2-3.5.9-4 0 0-1.2-.5-2.6 1.1a7.6 7.6 0 00-1.8 5z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      ...
      />
      <path
        d="M422.5 204.4s1.4.5 4.4-1c3-1.5 4.4 1.1 4 2.3 0 0-.7 1.6-3 1.2a8.3 8.3 0 01-5.4-2.4z"
        fill="#64b4d1"
        stroke="#00247d"
        strokeMiterlimit={2.6}
        strokeWidth={1.2}
      />
      <path d="M429.6 205.4s-1.3 1-3.9 0h-.2v.3s2.8 1.2 4.5.1c0 0 .2 0 0-.3h-.4z" fill="#fff" />
      <path
      ...
      <path
        ...
        strokeWidth={1.2}
      />
      <path d="M486.7 177.6s1 2.7.6 5.2c-.3 2.4.2 2.9 1 3.4.7.3 2.4-.4 2.5-2.2 0 0 2 3.8-1.8 6.3 0 0-2.7 1.7-5-.4-.8-.9-1.2-3-.7-5 0 0 .6-2.7-.5-5.5 0 0 1.6 1.6 1.2 4.9 0 0-.8 6 3.6 5.6 0 0 3 0 3-3.6 0 0-1.1 1.2-2.4.8a2.4 2.4 0 01-1.8-2.8c.1-1.6.6-4.3.3-6.7zM482 187s-.4 4.8-4.6 5.9c0 0 .6-.9-.3-3.3 0 0-1-1.2-1-3.3 0 0-1.2 1 .3 3.8 1 1.7 0 3.6-.1 3.7-.4.1 6.9-1 5.6-6.7zm-5.6-4.5s-1.1-1.2-1.2-3.8c0-2.7-.5-3.4-.9-3.6 0 0 .5 2.3.4 3.6a7 7 0 00.4 3s-2.4.3-3.9-3c-1.3-3.3-2.7-3-3.4-3 0 0 .8.1 2.4 3 1.6 3 2.1 3.7 6.2 3.7zm-10.8-7s1.2 3.2 1.4 4.8c0 0-3.1-1-4-3.5 0 0-3.2 1-2 4.7 0 0-2.9-1-4.2-3.2 0 0 1.6 1.2 3.1 1.7 0 0-.2-3.1 3.6-4.2 0 0 .6 2.7 2.6 3.3zm5-5.4s1.2 1.5 3.4 1.5a3.6 3.6 0 003.2-1.5s-.1 2.6-3.2 2.7c0 0-3.3 0-3.3-2.7zm-13.4 18.5l2 1.9s1.2 1.2 2-.3c0 0 1.3-2.4 2.9-2.2 0 0-1.2.7-2.4 3 0 0-.2.7-1.2.8-.5 0-1 .2-1.8-.7 0 0-.7-.9-1.5-2.4zm16.7-29.4c-3.2 0-.5 2.4-.5 2.4 0 4-3.1 5.4-5.3 4.2-2.2-1.2-.4-4-.4-4s-2.4 1.5-1 3.9c1.6 2.4 5.7 1.2 7.2-.9 1.5 2.2 5.7 3.3 7.1.9 1.7-2.4-.8-4-.8-4s1.8 2.9-.5 4c-2.1 1.3-5.4 0-5.2-4 0 0 2.7-2.5-.5-2.5zm2-4.4s1.2 2 1 5c0 0 .9-3-1-4.9zm-10 4.7s-.3-2.2-2.4-2.4c0 0 1.9 1.3 2.4 2.4zm16 0s.3-2.2 2.5-2.4c0 0-1.8 1.3-2.4 2.4zm-19.2 3.2s1.6.5 2.6-.7zm-5.4-13.1s1.9-.1 3.8 2.7c0 0-1.9 1-2.4 1.6 0 0 0-1 1-1.7 0 0-.4-1.4-2.4-2.5zm32 0s-2-.1-3.9 2.7c0 0 2 1 2.4 1.6 0 0 0-1-1-1.7 0 0 .4-1.4 2.5-2.5zm-14.7 2.2s1.7.5 3.8-.7c0 0 2.6-1.4 4.3 0 0 0-1.4-.7-4.3.7 0 0-2.7 1.6-3.8 0z" />
      <path d="M476.4 153.6s1.4-2.5 6-2c0 0-1.3 3.6-6 2z" fill="#fff" />
      <ellipse cx={479.4} cy={152.8} fill="#784421" rx={0.8} ry={1.1} />
      <ellipse cx={479.4} cy={152.8} rx={0.5} ry={0.7} />
      <path d="M466.8 148.1s2.8.3 4.6 1.2c0 0 1.8 1.2 3.8-.3 0 0 2.2-1.4 3.7-3.1 0 0-3.5 2.3-4.8 2.7 0 0-1.2-1-1.5-2.3 0 0 0-1 2-2.7 0 0-2.5.8-3 2.9a7.2 7.2 0 001.4 2.3s-.4.3-1.6-.6c0 0-2.8-.8-4.6 0zm7.2 17c-2.4 2.1 0 1.9 0 1.9s2.4.2 0-2zm-1.4-13.2s-1.8.5-4-.7c0 0-2.6-1.4-4.3 0 0 0 1.5-.7 4.3.7 0 0 2.9 1.6 4 0z" />
      <path d="M470.8 153.6s-1.5-2.5-6-2c0 0 1.2 3.6 6 2z" fill="#fff" />
...
export const BMFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
