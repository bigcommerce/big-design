...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <g fillRule="evenodd">
        <path d="M269.6 290.8L197 367.3l-1.2-1.6 72.4-76.5 1.2 1.6zm50.4 12.5l-94.8 100-1.6-1.6 94.7-100z" />
        <path
      ...
      <path
        ...
        transform="matrix(.45 0 0 .64 72.4 -59.8)"
      />
      <path d="M206.2 116l72.4 76.5 1.3-1.6-72.4-76.5z" fillRule="evenodd" />
      <path
      ...
      <path
        ...
        transform="matrix(.58 0 0 .62 9.6 -10.2)"
      />
      <path d="M183.8 158l94.8 100 1.7-1.6-94.8-99.9z" fillRule="evenodd" />
      <path
      ...
      />
      <g fillRule="evenodd">
        <path d="M370.4 290.8l72.5 76.5 1.3-1.6-72.5-76.5zM320 303.3l94.8 100 1.6-1.6-94.7-100z" />
        <path
          d="M478.4 60.2v88.6l17.7 88.6 17.7-88.6V60.2z"
          fill="gray"
          stroke="#000"
      ...
      <g fillRule="evenodd" strokeWidth="1pt">
        ...
        <path
          ...
          transform="matrix(-.45 0 0 .64 567.6 -59.8)"
        />
        <path d="M433.8 116l-72.4 76.5-1.3-1.6 72.4-76.5z" />
        ...
        <path
          ...
          transform="matrix(-.58 0 0 .62 630.4 -10.2)"
        />
        <path d="M456.2 158l-94.8 100-1.7-1.6 94.8-99.9z" />
        <path
          d="M460.6 184.3l17.7 35.4v17.7c-.8-1.3 0 17.7-17.7 17.7S443 219.7 443 219.7s-17.7 35.4-17.7 70.9 17.7 53.1 17.7 53.1-2.6-36.7 17.7-35.4c20.4 1.2 17.7 17.7 17.7 17.7v35.4h17.8V219.7l17.7-35.4-27.2-53.2-26 53.1z"
          fill="#cececc"
          stroke="#000"
      ...
      <g fillRule="evenodd" stroke="#000">
        <path
          d="M198.6 78l-89.7 35.4 89.7 35.4 44.8-17.7 22.4 17.7 22.4 35.4 22.5-35.4 22.4-17.7H1535V95.7H333l-22.4-17.8c0-17.7 4.7-35.4 22.5-35.4h89.6c0-17.7-44.8-53.1-134.5-53.1-89.6 0-134.5 35.4-134.5 53.1h89.7c17.7 0 22.4 17.7 22.4 35.5l-22.4 17.7z"
          fill="#908f8a"
          strokeWidth={4.5}
      ...
      <g fill="#ffdf00" fillRule="evenodd" stroke="#000" strokeWidth="1pt">
        ...
        />
        <path
          d="M579.8 250c-14.9-8.1-31.2-12.6-48.3-12.6s-33.4 4.5-48.3 12.5l7 16.4a82.8 82.8 0 0182.7 0z"
          transform="matrix(.58 0 0 .62 9.6 -10.2)"
        />
        <path
          d="M579.8 250c-14.9-8.1-31.2-12.6-48.3-12.6s-33.4 4.5-48.3 12.5l7 16.4a82.8 82.8 0 0182.7 0z"
