...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({ svgRef, title = 'GD flag', theme, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <use height="100%" transform="matrix(52.8 0 0 52.8 320 240)" width="100%" xlinkHref="#GDFlagIcon__c" />
      <use height="100%" transform="translate(-30.3)" width="100%" x={-100} xlinkHref="#GDFlagIcon__d" />
      <use
        height="100%"
        id="GDFlagIcon__d"
      ...
      />
      <use height="100%" transform="translate(30.3)" width="100%" x={100} xlinkHref="#GDFlagIcon__d" />
      <path d="M102.3 240.7a80.4 80.4 0 0033.5 33.2 111 111 0 00-11.3-45l-22.2 11.8z" fill="#ce1126" />
      <path
        d="M90.1 194.7c10.4 21.7-27.1 73.7 35.5 85.9a63.2 63.2 0 01-10.9-41.9 70 70 0 0132.5 30.8c16.4-59.5-42-55.8-57.1-74.8z"
        fill="#fcd116"
      />
      <use height="100%" transform="translate(-30.3 414.6)" width="100%" x={-100} xlinkHref="#GDFlagIcon__d" />
      <use height="100%" transform="matrix(31.2 0 0 31.2 320 448.2)" width="100%" xlinkHref="#GDFlagIcon__c" />
      <use height="100%" transform="translate(30.3 414.6)" width="100%" x={100} xlinkHref="#GDFlagIcon__d" />
    </svg>
  );
};
