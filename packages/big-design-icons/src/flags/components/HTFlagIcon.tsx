      ...
      <g fill="#f1b517" stroke="#000" strokeWidth={0.2}>
        ...
        <g transform="translate(-80) scale(1.6)">
          <g id="HTFlagIcon__a">
            ...
            <path d="M239.4 136.5l1.8 8h1.4l-3.2-8z" fill="#fff" />
            <path d="M241.9 150.6l-2.5-5.5 1-.2 4.7 9-3.2-3.3z" />
            <path d="M236 138.8l2.9 7.6h1.4l-4.2-7.6z" fill="#fff" />
            <path d="M242.3 151.4l-11.5-12.5c-3.6 2.8-2.9 8-2.9 8l13 10.2 1.3-5.7z" fill="#0a328c" />
            <path d="M248.9 158.2l-8.5-8.6c-3.6.2-.8 5.5-.6 6.2l9 7.7v-5.3z" fill="#d20014" />
            ...
            <path
              ...
              stroke="#d20014"
            />
            <path d="M237.3 154.7l-14.4-11.4c-2.5 2.5-.4 10.2-.4 10.2l14 7.6.7-6.4z" fill="#0a328c" />
            <path d="M249.2 164l-11.9-9.6c-4 .6-.8 6.5-.6 7.2l12.5 6.8v-4.5z" fill="#d20014" />
            ...
            <path
              ...
              fill="#0a328c"
            />
            <path d="M248.3 168.5l-12.5-7.3c-4 .5 0 8 .3 8.7l12.2 4.3v-5.7z" fill="#d20014" />
          ...
          <use height="100%" transform="matrix(-1 0 0 1 499.9 0)" width="100%" xlinkHref="#HTFlagIcon__a" />
        </g>
        <g transform="translate(-80) scale(1.6)">
          <path d="M248.8 125.6l-.5 9h2.9l-.4-9 3-.3-.3-3.6-7.5.3v3.2l2.8.4z" fill="#016a16" stroke="#016a16" />
          ...
          <use height="100%" transform="matrix(-1 0 0 1 499.9 0)" width="100%" xlinkHref="#HTFlagIcon__b" />
        ...
        <g transform="translate(-80) scale(1.6)">
          <use height="100%" transform="matrix(1 0 0 -1 0 320.4)" width="100%" xlinkHref="#HTFlagIcon__c" />
          <path
          ...
          <g id="HTFlagIcon__d">
            ...
            <path d="M238.7 174.3l-11.2-16.5-.5.5 11 16.4.7-.4z" fill="#503200" />
            <path d="M228.6 158.5l-1.2-2c-.3-.4-.6-.5-1.1-.2-.5.2-.4.7-.2 1.1l1 1.9 1.5-.8z" fill="#fff" />
            ...
            <path
              ...
              fill="#fff"
            />
            <path d="M246.4 162.5l-.2-1.7c-.3-.7-1-.1-1 .2l.2 1.7 1-.2z" fill="#fff" />
            <path
          ...
          <use height="100%" transform="matrix(-1 0 0 1 499.9 0)" width="100%" xlinkHref="#HTFlagIcon__d" />
          <path
