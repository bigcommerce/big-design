    ...
    >
      ...
      <g fill="#f1b517" stroke="#000" strokeWidth={0.2}>
        ...
        <g transform="translate(-80) scale(1.6)">
          ...
          <use width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)" xlinkHref="#HTFlagIcon__a" />
        </g>
        <g transform="translate(-80) scale(1.6)">
          <path fill="#016a16" stroke="#016a16" d="M248.8 125.6l-.5 9h2.9l-.4-9 3-.3-.3-3.6-7.5.3v3.2l2.8.4z" />
          <g id="HTFlagIcon__b" fill="#016a16">
          ...
          <use width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)" xlinkHref="#HTFlagIcon__b" />
        ...
        <g transform="translate(-80) scale(1.6)">
          <use width="100%" height="100%" transform="matrix(1 0 0 -1 0 320.4)" xlinkHref="#HTFlagIcon__c" />
          <path
            fill="#016a16"
            stroke="#fff"
            strokeLinecap="round"
          ...
          <use width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)" xlinkHref="#HTFlagIcon__d" />
          <path
            fill="#0a328c"
            stroke="#0a328c"
