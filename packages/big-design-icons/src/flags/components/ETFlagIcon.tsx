...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({ svgRef, title = 'ET flag', theme, ...props }) => {
  ...
  return (
    <svg aria-hidden={ariaHidden} aria-labelledby={titleId} ref={svgRef} viewBox="0 0 640 480" {...props}>
      ...
      <g clipPath="url(#ETFlagIcon__a)" fillRule="evenodd" strokeWidth="1pt" transform="translate(57.5) scale(.94)">
        ...
        <circle cx={534.2} cy={353} fill="#006bc6" r={199.7} transform="matrix(.54 0 0 .54 -25.8 74)" />
        <path
