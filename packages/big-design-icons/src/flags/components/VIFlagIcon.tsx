  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
      />
      <g fill="#f4c53d" stroke="#010002" strokeMiterlimit={10} strokeWidth={1.5}>
        ...
        <path d="M311 92.2c-10-.5-6.1-9.8-6.1-9.8" fill="none" />
      ...
      />
      <path
        d="M448.2 333.9l-15 19.2 3.4 10.8-30.9 36-2.8-16.6-16-1.2 30.8-36 10.4 2.5 16-20.4s4.4 2.2 4.1 5.7zm-382.7-45c3.6-1.5 6.2-2.9 6.2-6.7 0-1-.5-3-1.5-6.1L46 202a59 59 0 00-3-7.9c-1.1-2-3.2-2.9-6.1-4h30.7c-3.3 1.5-6.4 2.7-6.3 6.3 0 1.3.4 3.2 1.1 5.7l18.6 58 18.5-58a20 20 0 001.1-5.7c0-3.7-3.2-5-6.3-6.4h29.8c-2.7 1.1-5 2-6 4.1a63 63 0 00-3.1 8L90.8 276a37.9 37.9 0 00-1.5 6.1s-1.1 4.7 6.2 6.7zm515.3-7.6v-83.7c0-1.4-.3-2.5-.8-3.3s-2.5-3-5.5-4.2h27.7a11.5 11.5 0 00-5.5 4.2c-.5.8-.7 1.9-.7 3.3v83.7c0 1.5.2 2.6.7 3.4.5.8 2.5 2.8 5.5 4.2h-27.7c3-1.4 5-3.4 5.5-4.2.5-.8.8-1.9.8-3.4z"
        fill="#0081c6"
        stroke="#010002"
        strokeMiterlimit={10}
        strokeWidth={1.5}
...
export const VIFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
