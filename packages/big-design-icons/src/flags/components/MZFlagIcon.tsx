...
const FlagIcon: React.FC<FlagIconProps & PrivateIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#MZFlagIcon__a)" transform="scale(.9375)">
        <path d="M0 0h768v160H0z" fill="#009a00" fillRule="evenodd" />
        <path d="M0 160h768v16H0z" fill="#fff" fillRule="evenodd" />
        <path d="M0 176h768v160H0z" fill="#000001" fillRule="evenodd" />
        <path d="M0 336h768v16H0z" fill="#fff" fillRule="evenodd" />
        <path d="M0 352h768v160H0z" fill="#ffca00" fillRule="evenodd" />
        <path d="M0 0v512l336-256z" fill="red" fillRule="evenodd" />
        <path
...
export const MZFlagIcon = memo(createStyledFlagIcon(FlagIconWithForwardedRef));
