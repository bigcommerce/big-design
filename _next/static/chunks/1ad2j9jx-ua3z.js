...
`;e.s(["NextLink",0,({children:e,href:n})=>(0,t.jsx)(r,{href:n,children:e})])},43565,e=>{"use strict";var t=e.i(80447),n=e.i(13332),o=e.i(7277),r=e.i(99161),i=e.i(77136),l=e.i(27746),a=e.i(21908),s=e.i(83603),c=e.i(52510),d=e.i(29636),u=e.i(49653);e.s(["default",0,()=>(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.H1,{children:"Select"}),(0,t.jsxs)(o.Panel,{header:"Overview",headerId:"overview",children:[(0,t.jsxs)(n.Text,{children:[(0,t.jsx)(i.Code,{primary:!0,children:"Select"})," gives merchants the ability to make a single selection or multiple selections from a list of options."]}),(0,t.jsx)(n.Text,{bold:!0,children:"When to use:"}),(0,t.jsx)(c.List,{children:(0,t.jsx)(c.List.Item,{children:"When a user needs to make selections in a form."})})]}),(0,t.jsx)(o.Panel,{header:"Implementation",headerId:"implementation",children:(0,t.jsx)(a.ContentRoutingTabs,{id:"implementation",routes:[{id:"basic",title:"Basic",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(n.Text,{children:[(0,t.jsx)(i.Code,{primary:!0,children:"Selects"})," are typeable inputs with selectable options."]}),(0,t.jsx)(l.CodePreview,{children:`function Example() {
...
}`})]},"basic")},{id:"position",title:"Position",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(n.Text,{children:[(0,t.jsx)(i.Code,{primary:!0,children:"Select"})," can be anchored in different directions with the"," ",(0,t.jsx)(i.Code,{primary:!0,children:"position"})," property. It will automatically find a position if there's not enough space in the chosen direction."]}),(0,t.jsx)(l.CodePreview,{children:`<Grid gridColumns="repeat(4, 1fr)">
  <Select
    label="Select"
    onOptionChange={() => null}
    options={[
  ...
  <Select
    ...
    required
  />
</Grid>`})]},"position")},{id:"max-height",title:"Max height",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(n.Text,{children:["Once the content is longer than the max-height, the ",(0,t.jsx)(i.Code,{primary:!0,children:"Select"})," ","will be scrollable. It is possible to modify the dimension by passing a"," ",(0,t.jsx)(i.Code,{primary:!0,children:"maxHeight"})," property."]}),(0,t.jsx)(l.CodePreview,{children:`<Grid gridColumns="repeat(3, 1fr)">
  <Select
    label="Select"
    onOptionChange={() => null}
    options={[
  ...
  <Select
    ...
    required
  />
</Grid>`})]},"max-height")},{id:"disabled",title:"Disabled",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(n.Text,{children:["It is possible to disable the entire ",(0,t.jsx)(i.Code,{primary:!0,children:"Select"})," component, similar to how you would disable a native HTML select element, by using the"," ",(0,t.jsx)(i.Code,{primary:!0,children:"disabled"})," property."]}),(0,t.jsx)(l.CodePreview,{children:`<Form>
  <FormGroup>
    <Select
      disabled
      label="Select"
...
`})]},"disabled")},{id:"action",title:"Action",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(n.Text,{children:["Accepts an ",(0,t.jsx)(i.Code,{children:"action"})," object to display at the end of the list."]}),(0,t.jsx)(l.CodePreview,{children:`<Form>
  <FormGroup>
    <Select
      action={{
...
</Form>`})]},"action")},{id:"error",title:"Error",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(n.Text,{children:["An ",(0,t.jsx)(i.Code,{primary:!0,children:"error"})," prop receives a ",(0,t.jsx)(i.Code,{children:"string"})," to display."]}),(0,t.jsx)(l.CodePreview,{children:`<Form>
  <FormGroup>
    <Select
...
</Form>`})]},"error")},{id:"select-group",title:"Select group",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(n.Text,{children:["It is possible to create grouped options with labels with a"," ",(0,t.jsx)(i.Code,{primary:!0,children:"Select Group"})," by passing ",(0,t.jsx)(i.Code,{primary:!0,children:"label"})," and"," ",(0,t.jsx)(i.Code,{primary:!0,children:"options"})," to the top-level ",(0,t.jsx)(i.Code,{primary:!0,children:"options"})," ","property."]}),(0,t.jsx)(l.CodePreview,{children:`<Form>
  <FormGroup>
    <Select
      filterable
      label="My Options"
...
</Form>`})]},"select-group")},{id:"description",title:"Description",render:()=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsx)(n.Text,{children:"It is possible to add a description for select options and actions."}),(0,t.jsx)(l.CodePreview,{children:`function Example() {
...
}`})]},"description")}]})}),(0,t.jsx)(o.Panel,{header:"Props",headerId:"props",children:(0,t.jsx)(a.ContentRoutingTabs,{id:"props",routes:[{id:"select",title:"Select",render:()=>(0,t.jsx)(u.SelectPropTable,{})},{id:"select-option",title:"SelectOption",render:()=>(0,t.jsx)(u.SelectOptionPropTable,{})},{id:"select-action",title:"SelectAction",render:()=>(0,t.jsx)(u.SelectActionPropTable,{})},{id:"select-group",title:"SelectGroup",render:()=>(0,t.jsx)(u.SelectGroupPropTable,{})}]})}),(0,t.jsx)(o.Panel,{header:"Do's and Don'ts",headerId:"guidelines",children:(0,t.jsx)(s.GuidelinesTable,{discouraged:[(0,t.jsxs)(t.Fragment,{children:["Don’t use ",(0,t.jsx)(i.Code,{primary:!0,children:"Select "}),"component when user needs to make more than one selection (see ",(0,t.jsx)(d.NextLink,{href:"/multi-select",children:"MultiSelect"}),")."]}),(0,t.jsxs)(t.Fragment,{children:["In most cases avoid using long ",(0,t.jsx)(i.Code,{primary:!0,children:"labels"})," (ideally less than three words)."]})],recommended:[(0,t.jsxs)(t.Fragment,{children:["Use within ",(0,t.jsx)(d.NextLink,{href:"/panel",children:"Panels"}),"."]}),"Create all select options within a container.",(0,t.jsxs)(t.Fragment,{children:["Use for a single selection between 4 or more pre-defined ",(0,t.jsx)(i.Code,{primary:!0,children:"options"}),"."]}),"Default a selection if possible.","Add placeholder text if additional context is needed.","Logically group select options when it makes sense."]})})]})])},44408,(e,t,n)=>{let o="/select";(window.__NEXT_P=window.__NEXT_P||[]).push([o,()=>e.r(43565)]),t.hot&&t.hot.dispose(function(){window.__NEXT_P.push([o])})}]);