...
`}
`;m.defaultProps={theme:g.theme};let p=e=>{let{as:r,gridArea:i,gridColumn:s,gridColumnEnd:o,gridColumnStart:n,gridRow:l,gridRowEnd:a,gridRowStart:d,...c}=e;return(0,t.jsx)(m,{forwardedAs:r,...c,...function(e){let{gridArea:t,gridColumn:r,gridColumnEnd:i,gridColumnStart:s,gridRow:o,gridRowEnd:n,gridRowStart:l}=e;return{$gridArea:t,$gridColumn:r,$gridColumnEnd:i,$gridColumnStart:s,$gridRow:o,$gridRowEnd:n,$gridRowStart:l}}(e)})};e.s(["GridItem",0,p],57087);var f=e.i(87166);let y=(0,d.default)(n.Box).withConfig({displayName:"styled.tsx__StyledGrid",componentId:"sc-5ca71989-0"})`
  ${d.css`
...
`}
  ...
  ${(0,f.withDisplay)()}
`;y.defaultProps={theme:g.theme};let x=e=>{let{as:r,display:i,forwardedRef:s,gridAreas:o,gridAutoColumns:n,gridAutoFlow:l,gridAutoRows:a,gridColumns:d,gridColumnGap:c,gridGap:u,gridRows:h,gridRowGap:g,gridTemplate:m,...p}=e;return(0,t.jsx)(y,{$display:i,display:i,forwardedAs:r,ref:s,...p,...function(e){let{gridAreas:t,gridAutoColumns:r,gridAutoFlow:i,gridAutoRows:s,gridColumns:o,gridColumnGap:n,gridGap:l,gridRows:a,gridRowGap:d,gridTemplate:c}=e;return{$gridAreas:t,$gridAutoColumns:r,$gridAutoFlow:i,$gridAutoRows:s,$gridColumns:o,$gridColumnGap:n,$gridGap:l,$gridRows:a,$gridRowGap:d,$gridTemplate:c}}(e)})},v=(0,i.forwardRef)((e,r)=>(0,t.jsx)(x,{...e,forwardedRef:r}));e.s(["Grid",0,v],25934);var $=e.i(74474),b=e.i(13332);let j=(0,d.default)(v).withConfig({displayName:"styled.ts__StyledAlert",componentId:"sc-b6699699-0"})`
...
`,w=(0,d.default)(b.StyleableH4).withConfig({displayName:"styled.ts__StyledHeader",componentId:"sc-b6699699-1"})`
  line-height: ${({theme:e})=>e.spacing.medium};
  margin-bottom: ${({theme:e})=>e.spacing.xxSmall};
`,I=(0,d.default)(b.StyleableSmall).attrs({as:"span"}).withConfig({displayName:"styled.ts__StyledMessageItem",componentId:"sc-b6699699-2"})`
...
`,S=(0,d.default)($.Link).withConfig({displayName:"styled.ts__StyledLink",componentId:"sc-b6699699-3"})`
  ...
  vertical-align: middle;
`;j.defaultProps={theme:g.theme},w.defaultProps={theme:g.theme},I.defaultProps={theme:g.theme},S.defaultProps={theme:g.theme};let C=(0,i.memo)(({className:e,style:a,header:d,messages:c=[],onClose:u,type:h="success",...g})=>{let m=(0,i.useId)(),f=(0,s.excludePaddingProps)(g),y=(0,i.useMemo)(()=>h&&(0,o.getMessagingIcon)(h),[h]),x=(0,i.useMemo)(()=>c.map(({text:e,link:r},i)=>(0,t.jsxs)(n.Box,{children:[(0,t.jsx)(I,{children:e})," ",r&&(0,t.jsx)(S,{external:r.external,href:r.href,target:r.target,children:r.text})]},i)),[c]),v=(0,i.useMemo)(()=>d&&(0,t.jsx)(w,{id:m,children:d}),[d,m]);return(0,t.jsxs)(j,{...f,$onClose:u,"aria-labelledby":d&&m,role:"alert",type:h,children:[(0,t.jsx)(p,{gridArea:"icon",children:y}),(0,t.jsxs)(p,{gridArea:"messages",children:[v,x]}),u&&(0,t.jsx)(p,{children:(0,t.jsx)(l.MessagingButton,{iconOnly:(0,t.jsx)(r.CloseIcon,{size:"large"}),onClick:u})})]})});e.s(["Alert",0,C],96224)},30304,e=>{"use strict";var t=e.i(18995),r=e.i(81542),i=e.i(59572);let s=i.StyleableButton,o=(0,r.default)(i.StyleableButton).withConfig({displayName:"private.ts__MessagingButton",componentId:"sc-ed9fbd3c-0"})`
...
`;e.s(["GlobalStyles",0,()=>{let e=(0,s.useContext)(o.ThemeContext)??r.theme;return(0,t.jsx)(n,{$fontFamily:e.typography.fontFamily})}])},7277,85588,69194,30134,e=>{"use strict";var t=e.i(80447),r=e.i(99161),i=e.i(1431);e.s(["isClient",0,!0,"isProduction",0,!0],85588);let s=e=>{};e.s(["warning",0,s],69194);var o=e.i(47085),n=e.i(18995),l=e.i(81542);let a=l.default.span.withConfig({displayName:"styled.tsx__StyledBadge",componentId:"sc-c9d9457-0"})`
  ...
  ${({theme:e,$variant:t})=>"primary"===t&&l.css`
    ...
    `}
`;a.defaultProps={theme:n.theme};let d=(0,r.memo)(e=>{let{className:r,style:i,label:s,variant:n,margin:l,marginTop:d,marginRight:c,marginBottom:u,marginLeft:h,marginVertical:g,marginHorizontal:m,...p}=e;return"string"==typeof s?(0,t.jsx)(a,{...p,...(0,o.toTransientMarginProps)(e),$variant:n??"secondary",children:s}):null});d.displayName="Badge",e.s(["Badge",0,d],30134);var c=e.i(1304),u=e.i(59572),h=e.i(65059),g=e.i(13332);let m=(0,l.default)(c.Box).withConfig({displayName:"styled.tsx__StyledPanel",componentId:"sc-cb69a69c-0"})`
...
`,"getMessagingIcon",0,(e,n)=>{let l=n?"large":"xLarge";switch(e){case"success":return(0,t.jsx)(r.CheckCircleIcon,{color:"success",size:l});case"error":return(0,t.jsx)(i.ErrorIcon,{color:"danger",size:l});case"warning":return(0,t.jsx)(o.WarningIcon,{color:"warning50",size:l});case"info":return(0,t.jsx)(s.InfoIcon,{color:"primary60",size:l})}}])},52510,e=>{"use strict";var t=e.i(80447),r=e.i(81542);let i=r.css`
  ...
  ${({$reset:e,theme:t})=>e&&r.css`
      ${t.helpers.listReset};
    `}
`,s=r.default.ol.withConfig({displayName:"styled.tsx__StyledOrderedList",componentId:"sc-6a6922be-0"})`
  ${i};
`,o=r.default.ul.withConfig({displayName:"styled.tsx__StyledUnorderedList",componentId:"sc-6a6922be-1"})`
  ${i}
`,n=({columnCount:e=1,columnGap:r="normal",as:i="ul",children:n,reset:l,...a})=>(0,t.jsx)("ol"===i?s:o,{$columnCount:e,$columnGap:r,$reset:l,...a,children:n});n.Item=({...e})=>(0,t.jsx)("li",{...e}),e.s(["List",0,n],52510)},51969,e=>{"use strict";var t=e.i(80447),r=e.i(65059),i=e.i(13332),s=e.i(74474),o=e.i(60785),n=e.i(99161),l=e.i(77136),a=e.i(57115),d=e.i(95899),c=e.i(81542);let u=(0,c.default)(r.Flex).withConfig({displayName:"styled.tsx__StyledFlex",componentId:"sc-19f856ee-0"})`
  cursor: pointer;
  display: inline-flex;
  flex-direction: row;
